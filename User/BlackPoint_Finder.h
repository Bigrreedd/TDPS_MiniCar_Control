...
// 黑点判断阈值百分比。
// 传感器为数字量(0/4095)，经3帧移动平均后取值仅 0/1365/2730/4095：
//   0.2 阈值(819)会把 1365(近3帧中2帧是黑)判白 → 边缘通道换道瞬间系统性偏白，
//   质心被放大、丢线变快(2026-06-05 12:24 实测震荡发散根因)。
//   0.5 阈值(2047)使 1365→黑、2730→白 = 3帧2票多数表决，对称防抖。
#define BLACK_POINT_THRESHOLD_PERCENT 0.5f
